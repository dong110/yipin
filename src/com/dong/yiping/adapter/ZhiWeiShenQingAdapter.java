...
import com.dong.yiping.adapter.OneFragmentAdapter.ViewHolderTwo;
...
public class ZhiWeiShenQingAdapter extends BaseAdapter{

	private Context mContext;
	private List<GetJob> listGetJob;
	public ZhiWeiShenQingAdapter(Context mContext, List<GetJob> listGetJob) {
